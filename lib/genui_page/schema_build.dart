...
final riddleCard = CatalogItem(
  ...
  widgetBuilder: (itemContext) {
    ...
    // Tự động cấu hình màu sắc và icon theo Category để UI sinh động
    ...
    // Dùng StatefulBuilder quản lý biến bool cục bộ để lật/mở nội dung mà không cần gọi đến surfaceContext
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // Khối hiển thị lưu ý (hint) nếu có
                        ...
                        // Nút tương tác Đóng / Mở rộng cẩm nang hướng dẫn
                        Center(
                        ...
                        // Vùng Animation tự động co giãn chiều cao khi có biến động nội dung
                        AnimatedSize(
